  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        >
          <h1 className="text-3xl text-pink-300 mb-8 leading-relaxed">My Sorry Apology to You…</h1>
          ...
          >
            <p className="text-purple-200 text-lg mb-8 leading-relaxed">
              I admit my mistake and I’m really sorry — my behaviour wasn’t right, and I regret it.
            </p>
